...
def ber(bI_src, bQ_src, dI_sym, dQ_sym,
    ...
    return {
        ...
        "E_total":   int(best["tot"]),   # <-- Nuevo
        "E_I":       int(best["errI"]),  # <-- Nuevo
        "E_Q":       int(best["errQ"]),  # <-- Nuevo
    }
    # --- FIN DE LA SECCIÓN MODIFICADA ---

# (El código duplicado que tenías al final se elimina)