module top_global #(
    ...
    parameter integer NB_WIDE     = 22, // cantidad de bit para la entrada de la fft
    parameter integer NBF_WIDE    = 10 //enteros fft
)(
    input  wire                        clk,
    input  wire                        rst,
    ...
    // - si es el ultimo sample, garantizamos fft_in_ready_w 
